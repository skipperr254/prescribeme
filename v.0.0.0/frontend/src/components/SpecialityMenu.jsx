...
const SpecialityMenu = () => {
    return (
        <div id="speciality" className="flex flex-col items-center gap-4 text-gray-600 py-16">
            ...
            <div className="flex justify-center gap-4 pt-5 overflow-scroll w-full">
                {specialityData.map(item => (
                    <Link to={`/doctors/${item.url}`} key={item.speciality} className="flex flex-col items-center text-xs flex-shrink-0 hover:translate-y-[-10px] transition-all duration-500">
